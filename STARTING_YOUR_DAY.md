# Starting Your Day – Daily Workflow

Each time you open a new Codespaces session or terminal, follow these steps.
...
## 2. Run your current program

Navigate to the program your class is learning and run it:
